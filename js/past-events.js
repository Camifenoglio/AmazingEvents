...
async function getData() {
    ...
    //creo una fn p/obtener categorias, las filtro, e imprimo dinamicamente los checkbox
    function displayCheckBox() {
        ...
        //imprimo input ceckbox dinamicos
        var inputCheckbox = ""
    ...
    //captura datos check
    //guardar los checked dinamicos en una variable array
    ...
    function arrayFiltrado() {
        ...
        //console.log (dato)
        displayPastCard(dato)
    }
    arrayFiltrado()

    function displayPastCard(datos) {
        let templateHtml = "";
        if (datos.length !== 0) {
        ...
        document.querySelector('.pastCard').innerHTML = templateHtml
    }
}
getData()